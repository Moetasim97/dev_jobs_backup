...
<div className="top_section ">
  <div className='filter_bar d-flex p-3 fit_content ' style={secondaryTheme}>
    <input type="text" id="nameInput" name="Name" className='collection' placeholder='Filter by title, company, expertise..'></input>
    ...
    <input type="text" id="countryInput" name="Country" className='collection' placeholder='Filter by location'></input>
