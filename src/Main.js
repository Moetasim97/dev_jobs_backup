...
import image from "./Group 10.png"
...
export default function Main({state,filter,toggler}){
  ...
  const [color,setColor]=React.useState("#5964e0")
  ...
  useEffect(()=>{
    ...
    window.innerWidth<768 ? setColor("white") : setColor("#5964e0")
...
<div className="top_section ">
  <div className="d-flex w-100 justify-content-center position_absolute">
  <div className='filter_bar d-flex p-3 fit_content align-items-baseline' style={secondaryTheme}>
  <div className="position_absolute">
  
    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill={color} onMouseDown={()=>{
      console.log(window.innerWidth)
    }} className="bi bi-search " viewBox="0 0 16 16">
       <path d="M11.742 10.344a6.5 6.5 0 1 0-1.397 1.398h-.001c.03.04.062.078.098.115l3.85 3.85a1 1 0 0 0 1.415-1.414l-3.85-3.85a1.007 1.007 0 0 0-.115-.1zM12 6.5a5.5 5.5 0 1 1-11 0 5.5 5.5 0 0 1 11 0z"/>
     </svg>
  </div>
   <input type="text" id="nameInput" name="Name" className='occupationField'  placeholder='Filter by title, company, expertise..' required></input>
   <div className="position_absolute">
   <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill={color} className="bi bi-geo-alt-fill " viewBox="0 0 16 16">
     <path d="M8 16s6-5.686 6-10A6 6 0 0 0 2 6c0 4.314 6 10 6 10zm0-7a3 3 0 1 1 0-6 3 3 0 0 1 0 6z"/>
   </svg>
   </div>
   <input type="text" id="countryInput" name="Country" className='locationField' placeholder='Filter by location' required></input>
   ...
   <div className="d-flex align-items-baseline">
     <div className='d-flex align-items-start mx-2'>
       ...
       <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="gray" class="bi bi-funnel d-none" viewBox="0 0 16 16">
 <path d="M1.5 1.5A.5.5 0 0 1 2 1h12a.5.5 0 0 1 .5.5v2a.5.5 0 0 1-.128.334L10 8.692V13.5a.5.5 0 0 1-.342.474l-3 1A.5.5 0 0 1 6 14.5V8.692L1.628 3.834A.5.5 0 0 1 1.5 3.5v-2zm1 .5v1.308l4.372 4.858A.5.5 0 0 1 7 8.5v5.306l2-.666V8.5a.5.5 0 0 1 .128-.334L13.5 3.308V2h-11z"/>
     ...
     <button className='search_btn px-4' onClick={()=>{
       ...
       filter(object)
     }}>Search <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="black" class="bi bi-search specific_search d-none" viewBox="0 0 16 16">
     <path d="M11.742 10.344a6.5 6.5 0 1 0-1.397 1.398h-.001c.03.04.062.078.098.115l3.85 3.85a1 1 0 0 0 1.415-1.414l-3.85-3.85a1.007 1.007 0 0 0-.115-.1zM12 6.5a5.5 5.5 0 1 1-11 0 5.5 5.5 0 0 1 11 0z"/>
   </svg></button>
   </div>
 </div>
...
<div className="middle_section container ">
  <div className="row g-3">
    {state !=undefined ? state.map((job,index)=>{ 
